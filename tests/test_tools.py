...
from src.tools.customers import lookup_customer, lookup_customer_by_id
from src.tools.orders import get_order_status, get_customer_orders
from src.tools.tickets import create_ticket, get_customer_tickets
...
def test_customer_lookup():
    ...
    print(f"  ✅ Found customer: Alice Johnson")
...
def test_customer_orders():
    ...
    print(f"  ✅ Customer order history works")
...
def test_refund_eligibility():
    ...
    print(f"  ✅ Delivered order is refund-eligible")
    ...
    print(f"  ✅ Processing order correctly flagged")
